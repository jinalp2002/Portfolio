    ...
    return (
        ...
        < div className="min-h-screen dark:bg-[#001927]" >
            <div className="dark:bg-[#001927] pl-2">
                <h1 className="text-3xl sm:text-4xl font-serif bg-gradient-to-r from-[#9d209a] to-[#0c1e73] bg-clip-text text-transparent pt-4 font-bold dark:from-[#ffe186] dark:to-[#80640e] ">Frontend Developer</h1>
                <h2 className="text-[8px] sm:text-xs dark:text-slate-200 text-black font-serif pt-3">Crafting pixel-perfect, animated web experiences <br />
            ...
            <div className="flex gap-6 mt-5 ml-7 ">
                <a href="#Projects" className="flex bg-[#01a8ae] rounded-full w-36 pl-2 text-xs pt-1 text-white cursor-pointer dark:bg-[#0487d9] ml-2">View my Projects
