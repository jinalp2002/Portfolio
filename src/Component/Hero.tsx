...
const Hero = () => {
    return (
        ...
        < div className="min-h-screen dark:bg-[#001927] font-serif" >
            ...
            <div className="flex gap-6 mt-5 ml-7 ">
                <a href="#Projects" className="flex bg-[#01a8ae] rounded-full w-36 md:w-52 pl-2 text-xs md:text-xl pt-1 text-white cursor-pointer dark:bg-[#0487d9] ml-2 md:h-20 ">View my Projects
                    <img src={assets.arrow_icon} alt="" className="h-5 md:h-8 w-5 md:w-8 ml-2" />
                </a>
                <a href="#About" className="bg-[#01a8ae] rounded-full w-20 md:w-36 pl-2 text-xs md:text-xl pt-1 text-white cursor-pointer dark:bg-[#0487d9]">About me</a>
            </div>
