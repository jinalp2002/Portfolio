        ...
        <div id="Projects" className="mt-7">
            <div className="bg-white dark:bg-[#14141a] rounded-xl shadow-lg p-5 ">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2  mt-7 ">
                    ...
                    {/* Project 2 */}
                    <div className="dark:bg-[#0b0f1a] border border-slate-800 rounded-2xl  bg-gradient-to-r from-[#3a0425] to-[#d387b6] dark:bg-gradient-to-r dark:from-[#314755] dark:to-[#26a0da] mt-7 w-72 p-6">
